...
function mapProtocolToForm(data) {
  ...
  const mapped = {
    ...
    exhaust_noise_db: toFormValue(measurement.exhaust_noise_db),
...
function buildMeasurementPayload(form) {
  return {
    ...
    exhaust_noise_db: emptyToNull(form.exhaust_noise_db),
...
function ProtocolInspection() {
  ...
  try {
    ...
    await Promise.all([
      api.patch(`/cars/protocols/${id}/update/`, protocolPayload),
      api.patch(`/cars/protocols/${id}/test-conditions/update/`, testConditionsPayload),
      api.patch(`/cars/protocols/${id}/road-conditions/update/`, roadConditionsPayload),
      api.patch(`/cars/protocols/${id}/power-supply/update/`, powerSupplyPayload),
      api.patch(`/cars/protocols/${id}/measurement/update/`, measurementPayload),
      api.patch(`/cars/protocols/${id}/brake/update/`, brakePayload),
      api.patch(`/cars/protocols/${id}/light/update/`, lightPayload),
    ]);
